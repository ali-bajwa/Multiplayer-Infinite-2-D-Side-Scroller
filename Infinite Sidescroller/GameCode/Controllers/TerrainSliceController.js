...
var TerrainSliceController = (function () {
	...
	var buildTerrainSlice = function(slice){
		...
		var vgap_min = 7;
		var vgap_len = 0;
		var hgap_min = 15;				//minimum size of gaps between platforms
		var hgap_len = 0; 		//current number of consecutive horizontal gaps
		var pit_max = 5;				//maximum len of pits in blocks
		var pit_len = 0; 		//current number of consecutive pits
		var has_pit = [];
		var pit_frequency = 1; 		//base percentage chance of a pit being dug
